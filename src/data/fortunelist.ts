let FortuneList = [
    {
        message: 'Acting on a good idea is better than just having a good idea.'
    },
    { message: 'The only people who never fail are those who never try.' },
    { message: 'Your difficult path will be rewarding.' },
    {
        message: 'Take calculated risks. This is different from being rash.'
    },
    { message: 'Accept the next proposition you hear.' },
    ...
    { message: 'The end of something marks the start of something new.' },
    ...
    { message: 'Your love life will be harmonious and full.' },
    { message: 'Now is a good time to finish up old tasks.' },
    {
        message:
            'Accept something that you cannot change, and you will feel better.'
    },
    { message: 'Wait before reacting negatively to someone.' },
    {
        message:
            'A master has failed more times than a beginner has even tried.'
    },
    { message: 'Be the person you needed in life.' },
    {
        message:
            'Worry less about controlling your emotions. Control your actions instead.'
    },
    { message: 'The answer is always "no" until you ask' },
    {
        message:
    ...
    {
        message:
            "Putting your happiness in someone else's hands only leads to sorrow."
    },
    {
        message: 'Biased self processing causes suffering.'
    },
    {
        message: "Don't get bent out of shape when things don't go your way."
    },
    {
        message: "Don't be discouraged. Every attempt is another step forward."
    },
    {
        message: "Don't let the past hold you back."
    },
    {
        message: 'Let yourself be seen. You will shine.'
    },
    {
        message: 'Practice gratitude and joy.'
    },
    {
        message:
